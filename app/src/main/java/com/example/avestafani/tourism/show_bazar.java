...
public class show_bazar extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_show_bazar);
        ...
        imgback.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent z=new Intent(show_bazar.this,kermanshah_bazar.class);
                startActivity(z);
            }
        });
