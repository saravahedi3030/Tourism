...
public class datamodel {
    ...
    public datamodel(String name, String name1, int img, String t1, String t2, String t3, int img1, int img2, int img3, int img4, int img5, int img6, int img7, int img8, int img9, int img10) {
        this.name = name;
        this.name1 = name1;
        this.img = img;
        this.t1 = t1;
