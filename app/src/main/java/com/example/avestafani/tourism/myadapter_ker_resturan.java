...
public class myadapter_ker_resturan extends RecyclerView.Adapter<myadapter_ker_resturan.myviewholder> implements View.OnClickListener {

    private List<datamodel_ker_resturan>mylist;
    ArrayList<datamodel_ker_resturan>filter;

    Context context;

    public myadapter_ker_resturan(List<datamodel_ker_resturan> mylist, Context context) {
        this.mylist = mylist;
    ...
    public myviewholder onCreateViewHolder(ViewGroup parent, int viewType) {
            View itemview= LayoutInflater.from(parent.getContext()).inflate(R.layout.list_resturan_kermanshah,parent,false);
        return new myviewholder(itemview);
    }

    @Override
    public void onBindViewHolder(myviewholder holder, int position) {
        final datamodel_ker_resturan mylist=filter.get(position);
        ...
        holder.card.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i=new Intent(v.getContext(),show_resturan.class);
