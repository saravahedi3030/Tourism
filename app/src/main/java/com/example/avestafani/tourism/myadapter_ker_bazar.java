...
public class myadapter_ker_bazar extends RecyclerView.Adapter<myadapter_ker_bazar.myviewholder> implements View.OnClickListener {

    private List<datamodel_ker_bazar>mylist;
    ArrayList<datamodel_ker_bazar>filter;
    Context context;

    public myadapter_ker_bazar(List<datamodel_ker_bazar> mylist, Context context) {
        this.mylist = mylist;
    ...
    public myviewholder onCreateViewHolder(ViewGroup parent, int viewType) {
            View itemview= LayoutInflater.from(parent.getContext()).inflate(R.layout.listdata_bazar_kermanshah,parent,false);
        return new myviewholder(itemview);
    }

    @Override
    public void onBindViewHolder(myviewholder holder, int position) {
        final datamodel_ker_bazar mylist=filter.get(position);
        ...
        holder.card.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i=new Intent(v.getContext(),show_bazar.class);
    ...
    static class myviewholder extends RecyclerView.ViewHolder {
        ...
        ImageView img,img11,img12,img13,img14,img15,img16,img17,img18,img19,img20;        CardView card;
        LinearLayout layout;
